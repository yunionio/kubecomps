  ...
  template:
    ...
    spec:
      ...
      - name: aws-vpc-cni-init
        image: {{.InitImage}} # "602401143452.dkr.ecr.us-west-2.amazonaws.com/amazon-k8s-cni-init:v1.13.4"
        env:
      ...
      containers:
        - name: aws-node
          image: {{.Image}} # "602401143452.dkr.ecr.us-west-2.amazonaws.com/amazon-k8s-cni:v1.13.4"
          ports:
            - containerPort: 61678
              name: metrics
          livenessProbe:
