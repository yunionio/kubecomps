...
func TestStdoutCallbackJSONResults(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			err: errors.Error("(results::JSONStdoutCallbackResults): Host 127.0.0.1 finished with 1 failures"),
		},
		{
			...
			err: errors.Error("(results::JSONStdoutCallbackResults): Host 127.0.0.1 finished with 1 unrecheable hosts"),
		},
	}
